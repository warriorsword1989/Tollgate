    ...
    <el-form :inline="true" class="wraper">
      ...
      <fieldset style="min-height:200px">
        ...
        <el-row :gutter="10">
          <el-col :span="10">
            <div style="display: flex;flex-direction: row" class="grid-content bg-purple">
              <div style="display:inline-block" class="label">装载区间吨数范围：</div>
              <div style="display:flex;flex-direction: row;text-align: center">
                <div style="width: 20px">{{'>'}}</div>
                <div style="width: 90px">
          ...
          <el-col :span="7">
            <div class="grid-content bg-purple">
              <div style="display:inline-block" class="label">装载费率倍数上限：</div>
          ...
          <el-col :span="7">
            <div class="grid-content bg-purple">
              <div style="display:inline-block" class="label">装载费率倍数下限：</div>
