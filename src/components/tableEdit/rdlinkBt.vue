<template>
  <div v-loading="loading" style="height:280px;overflow-y: auto" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
    ...
    <div class="grid-content">
      <div class="grid-wraper">
        <div class="grid-list">
          ...
          <div class="inputPart">
            <el-input :disabled="true" v-model="(this.dataModels.length && this.dataModels[0].name_bt) || originModel.name_bt"
              size="mini"></el-input>
          </div>
        </div>
        <div class="grid-list">
          ...
          <div class="inputPart">
            <el-input :disabled="true" v-model="(this.dataModels.length && this.dataModels[0].name_bt_id) || originModel.name_bt_id"
              size="mini"></el-input>
          </div>
        </div>
    ...
    <el-form v-for="(dataItem, index) in dataModels" :key="index" :model="dataItem" ref="dataItem" :inline="true"
      :inline-message="false" class="wraper">
        ...
        <div class="grid-list">
          ...
          <div style="flex:9" class="inputPart">
            <el-form-item prop="rate_class">
              <el-select @change="rateClassChange(dataItem.rate_class,index)" size="mini" v-model.number="dataItem.rate_class"
                placeholder="请选择">
            ...
            <div class="grid-list">
              ...
              <div class="inputPart">
                <el-form-item prop="tunnage_flag">
                  <el-select :disabled="dataModels[0].rate_class!=2" size="mini" v-model.number="dataItem.tunnage_flag"
                    placeholder="请选择">
    ...
    <div v-show="((hasData && $store.state.handleFlag=='update')||dataModels.length) || (dataModels.length && $store.state.handleFlag=='insert')"
      class="footerPart">
      <el-row :gutter="5">
