            ...
            <fieldset>
              ...
              <div class="grid-wraper">
                ...
                <div class="grid-list">
                  ...
                  <div class="inputPart">
                    <el-select size="mini" v-model.number="dataItem.lane_num" placeholder="请选择">
              ...
              <div class="grid-wraper">
                ...
                <div class="grid-list">
                  ...
                  <div class="inputPart">
                    <el-input v-model="dataItem.rate1" size="mini"></el-input>
                  </div>
                </div>
              </div>
              <div class="grid-wraper">
                <div class="grid-list">
                  ...
                  <div class="inputPart">
                    <el-select size="mini" v-model.number="dataItem.lane_num1" placeholder="请选择">
                      <el-option v-for="item in feeOptions" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </div>
  ...
  export default {
    ...
    methods: {
      ...
      addItem() {
        ...
        addItemData.car_class = this.dataModels.length;
