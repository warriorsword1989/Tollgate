...
fastmap.uikit.shapeEdit.ShapeEditor = L.Class.extend({
    ...
    loadTools: function () {
        ...
        this.toolController.addTool(new fastmap.uikit.shapeEdit.PointAddressAddTool());
        this.toolController.addTool(new fastmap.uikit.shapeEdit.PoiUpdateTool());
        this.toolController.addTool(new fastmap.uikit.shapeEdit.PointAddressUpdateTool());
    ...
    start: function (editResult, onFinish) {
        ...
        switch (type) {
            ...
            case 'TipNomalRestrictionResult':
                ...
                break;
            case 'PointAddressResult':
                defaultToolName = isCreate ? 'PointAddressAddTool' : 'PointAddressUpdateTool';
                break;
            default:
