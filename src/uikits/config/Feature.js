...
/**
 * 单例，只读 要素工具配置
 * @method FM.uikit.Config.Feature
 * @author LiuZhe
 * @date   2017-09-11
 * @return {object} 单例对象
 */
    ...
    var Singleton = function () {
        var config = {
            IXPOI: {
                ...
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: 'components/index/poi/ctrls/attr-base/generalBaseCtl.js',
                        tmpl: '@components/index/poi/tpls/attr-base/generalBaseTpl.html'
                    },
                    view: {
                        ctrl: 'components/index/poi/ctrls/attr-tips/poiPopoverTipsCtl.js',
                        tmpl: '@components/index/poi/tpls/attr-tips/poiPopoverTipsTpl.html'
                    }
                },
            ...
            IXPOINTADDRESS: {
                name: '点门牌',
                serverFeatureType: 'IXPOINTADDRESS',
                model: FM.dataApi.IXPOINTADDRESS,
                // depends: ['LUFACE', 'CMGBUILDING', 'RDLINK'],
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: 'components/index/pointAddress/ctrls/attr_pointAddress/pointAddressCtrl.js',
                        tmpl: '@components/index/pointAddress/tpls/attr_pointAddress/pointAddressTpl.html'
                    }
                },
            ...
            PointInfo: {
                name: '数据型点情报',
                serverFeatureType: 'PointInfo',
                model: FM.dataApi.PointInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
            ...
            LineInfo: {
                name: '数据型线情报',
                serverFeatureType: 'LineInfo',
                model: FM.dataApi.LineInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
            ...
            PolygonInfo: {
                name: '数据型面情报',
                serverFeatureType: 'PolygonInfo',
                model: FM.dataApi.PolygonInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
            ...
            QPointInfo: {
                name: '情报型点情报',
                serverFeatureType: 'QPointInfo',
                model: FM.dataApi.QPointInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
            ...
            QLineInfo: {
                name: '情报型线情报',
                serverFeatureType: 'QLineInfo',
                model: FM.dataApi.QLineInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
            ...
            QPolygonInfo: {
                name: '情报型面情报',
                serverFeatureType: 'QPolygonInfo',
                model: FM.dataApi.QPolygonInfo,
                depends: ['RDLINK'],
                template: { // 要素的页面片段
                    edit: { // 属性编辑片段
                        ctrl: null,
        ...
        /**
         * 根据要素类型获取要素的 extend 配置
         * @method getExtendTemplate
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} featType 要素类型
         * @return {object} extend 配置
         */
         ...
         * @date   2017-09-11
         * @param  {string} featType 要素类型
         * @return {boolean} 要素是点类型时返回true,否则false
         */
        ...
        /**
         * 根据nodeType获取对应的linkType
         * @method getLinkByNode
         * @author LiuZhe
         * @date   2017-09-11
        ...
        /**
         * 根据 linkType 获取对应的 nodeType
         * @method getNodeByLink
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} geoLiveType 要素类型
        ...
        /**
         * 根据要素类型获取要素在服务端对应的类型
         * @method getServerFeatureType
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} featType 要素类型
         * @return {string} 服务端对应的类型
         */
        ...
        /**
         * 根据 服务端对应的类型 获取要素在web端的类型
         * @method getServerFeatureType
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} serverFeatureType 服务端对应的类型
         * @return {string} web端的类型
         */
