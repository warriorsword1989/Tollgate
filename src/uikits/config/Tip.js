...
FM.uikit.Config.Tip = (function () {
    ...
    var Singleton = function () {
        ...
        /**
         * 获取 tip的关联要素
         * @method getRelateFeature
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} tipType tip类型
         * @return {string} tip的关联要素
         */
        ...
        /**
         * 根据 tip类型 获取 tip 依赖的其它要素
         * @method getDepends
         * @author LiuZhe
         * @date   2017-09-11
         * @param  {string} tipType tip类型
         * @return {array} tip依赖的其它要素
         */
